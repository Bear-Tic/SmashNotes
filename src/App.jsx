...
const App = (
  ...
  <Router>
    <ViewportHeight bg="brand.50" direction="row">
      ...
      <Navbar />
      <Switch>
        <Flex direction="column" w="calc(100% - 7rem)">
          <Route exact path="/">
          ...
          <Route exact path="/dashboard">
            <Box
              ...
              bg="white"
            >
              <Text fontSize="xl" fontWeight="600" position="absolute" top="50%" color="brand.500" ml={10}>Here is it</Text>
              <svg
                data-name="Layer 1"
                ...
                style={{
                  ...
                  filter: 'drop-shadow( 3px 3px 2px rgba(0, 0, 0, .05))',
                }}
              >
